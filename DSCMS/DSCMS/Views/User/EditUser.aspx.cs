    ...
    public partial class EditUser : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            try
            {
                ...
                if (ddCompanyName.SelectedValue != "")
                {

                    companyname = ddUserGroup.SelectedValue;
                ...
                GridView1.DataSource = ugm.getUserEdit(UserID, "Y", grpID, companyname);
        ...
        public void DropDown()
        {
            try
            {
                ...
                ddCompanyName.DataSource = cm.getAllCustomer("Y");
                ddCompanyName.DataTextField =  "CustomerName1";
                ddCompanyName.DataValueField = "CustomerId1";
        ...
        public void CertificateID_Click(object sender, EventArgs e)
        {
            ...
            if (ddCompanyName.SelectedValue != "")
            {
                ...
                companyname = ddCompanyName.SelectedValue;
