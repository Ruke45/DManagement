                     ...
                     <div class="form-horizontal" role="form" style="font-family:Cambria;">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-5">
                            <asp:TextBox ID="OldPassword" inputtype="password" TextMode="Password" CssClass="form-control" width="390" runat="server" Height="30"></asp:TextBox>
                            </div>
                              <div class="col-sm-3">
                            <asp:Label ID="lblErrorPassword" runat="server" Text="Label" visible="false" ForeColor="Red" align="cener">Wrong User password </asp:Label>
                                  <asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" ControlToValidate="OldPassword" ErrorMessage="Old password is a Required."  ForeColor="Red"></asp:RequiredFieldValidator>
                              </div>
                            <div class="col-sm-3">
                        </div></div>
