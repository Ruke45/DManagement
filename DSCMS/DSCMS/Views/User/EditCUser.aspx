<%@ Title="" Language="C#" AutoEventWireup="true" CodeBehind="EditCUser.aspx.cs" MasterPageFile="~/Master.Master" Inherits="DSCMS.Views.User.EditCUser" %>
 ...
 >
                              <Columns>
                                 <asp:BoundField HeaderText="User ID" DataField="User_ID" SortExpression="User_ID" />
                                  <asp:BoundField HeaderText="Designation" DataField="UserGroup_ID" SortExpression="User_ID" />
                      ...
                      <div class="form-horizontal" role="form" style="font-family:Cambria;">
                         ...
                         <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <asp:TextBox ID="txtDesignation"  name="address3" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-5">
                            <asp:TextBox ID="NewPassword" placeholder="Minimum 8 Characters, Numeric and special Characters are musts " Font-Size="X-Small" inputtype="password" TextMode="Password"  Height="30" CssClass="form-control" width="390" runat="server"></asp:TextBox>
                            </div>
                             <div class="col-sm-3">
