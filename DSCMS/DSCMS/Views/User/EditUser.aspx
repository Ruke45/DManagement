        ...
        <div class="col-md-10 col-md-offset-1 ">
             <div class="form-horizontal" role="form" style="font-family: Cambria;">
              <div class="row" id="div3">
                  ...
                  <br/><br />
                   <div class="group">
                        <label class="control-label col-md-2" for="email">Company Name</label>

                        <div class="col-md-3" runat="server" id="dieee">
                       <asp:DropDownList ID="ddCompanyName"  CssClass="form-control"   runat="server" AppendDataBoundItems="true"><asp:ListItem Text="All" Value="" />
