<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="CustomerRequestStatsusDetails.aspx.cs" Inherits="DSCMS.Views.Maintenance.CustomerRequestStatsusDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-cogs"></i> Certificate Request Details
                </li>
            </ol>
         ...
         <div class="row">
           </div><div class="col-lg-4"><asp:Button ID="btnShow" runat="server" Width="200" CssClass="btn btn-primary" style="display:none" Text="Back" OnClick="back"  /></div></div>
    <div class="row">
                  ...
                  <%--  </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-12 text-right" >
                            <asp:Button ID="btnRejectRequest" runat="server" Text="Reject Request" CssClass="btn btn-primary" Width="200px" style="display:none" OnClick="btnRejectRequest_Click" />
                           <%-- </div>
                            <div class="col-sm-4 text-right">--%>
                            <asp:Button ID="btnRequestCertificate" runat="server" Text="Genarate Certificate" CssClass="btn btn-primary" Width="200px" style="display:none" OnClick="btnRequestCertificate_Click" />
                            </div>
