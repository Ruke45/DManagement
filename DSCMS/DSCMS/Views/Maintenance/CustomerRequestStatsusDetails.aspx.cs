...
{
    public partial class CustomerRequestStatsusDetails : System.Web.UI.Page
    {
        ...
        string HSCODE_N_BTMROW = System.Configuration.ConfigurationManager.AppSettings["GOLOBALTMP"];
        ...
        protected void LoadCertificateRequest()
        {
            ...
            string id = Request.QueryString["RQID"];
        ...
        protected void back(object sender, EventArgs e)
        {
           ...
           Response.Redirect("CustomerRequestStatus.aspx", false);
            ...
            using (TransactionScope transactionScope = new TransactionScope())
            {
                try
                {
                    ...
                    */
                    ...
                    System.IO.FileStream PFX = new FileStream(pathe, FileMode.OpenOrCreate);
                    ...
                    for (int i = 0; i < SupList.Count(); i++)
                    {
                        if (SupList[i]._Remarks.Equals("Certification"))
                        {
                            ...
                            FileStream PFX2 = new FileStream(pathe, FileMode.OpenOrCreate);
