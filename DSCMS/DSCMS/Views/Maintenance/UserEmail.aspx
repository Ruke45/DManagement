<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.Master"  CodeBehind="UserEmail.aspx.cs" Inherits="DSCMS.Views.Maintenance.UserEmail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-lg-12">
                  <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-cogs"></i>Certificate Coordinates
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-md-10 col-md-offset-1 ">
            ...
            <div class="panel panel-default panel-table boxshadow">
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-9"> <h5>Co-ordinate List</h5>
 ...
 >
                              <Columns>
                                  ...
                                  <asp:BoundField HeaderText="CustomerID" Visible="true" DataField="Customer_ID"   SortExpression="Template_Name" ><ItemStyle Width="22%"></ItemStyle></asp:BoundField>
                                  <asp:BoundField HeaderText="Customer Name" Visible="true" DataField="Customer_Name"   SortExpression="Template_Name" ><ItemStyle Width="28%"></ItemStyle></asp:BoundField>
                                   <asp:BoundField HeaderText="Lower Left X Cordinate" DataField="LLX_Cordinates" SortExpression="Customer_Name" ItemStyle-HorizontalAlign="Right" ><ItemStyle Width="12%"></ItemStyle></asp:BoundField>
                                 <asp:BoundField HeaderText="Lower Left Y Cord" DataField="LLY_Cordinates" SortExpression="Customer_Name" ItemStyle-HorizontalAlign="Right" ><ItemStyle Width="12%"></ItemStyle></asp:BoundField>
                                   <asp:BoundField HeaderText="Upper Right X co-ord" DataField="URX_cordinates" SortExpression="Customer_Name" ItemStyle-HorizontalAlign="Right" ><ItemStyle Width="12%"></ItemStyle></asp:BoundField>
                                 <asp:BoundField HeaderText="Upper Right Y co-ord" DataField="URY_cordinates" SortExpression="Customer_Name" ItemStyle-HorizontalAlign="Right" ><ItemStyle Width="12%"></ItemStyle></asp:BoundField>
                                  
                                   
                                 <asp:TemplateField HeaderText = "Edit Option"><ItemStyle Width="12%"></ItemStyle>
                                   <ItemTemplate>
...
<asp:Panel ID="Panel1" runat="server" CssClass="modalPopup modal-dialog modal-lg" align="center" style = "display:none">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Edit Certificate Config</h4>
      </div>
    ...
    <div class="modal-content">
      ...
      ErrorMessage="Enter Height Value Correctly " ForeColor="Red" Display="Dynamic" ValidationExpression="[0-9]*\.?[0-9]*"></asp:RegularExpressionValidator>
                          ...
                          <div class="form-group">
                            <label class="control-label col-sm-2" for="email">Upper Right Y co-ordinate</label>
                            <div class="col-sm-1">
                            <asp:TextBox ID="txtAWidth"   name="address3" CssClass="form-control" Width="280" runat="server"></asp:TextBox>
                            </div>
                              <div class="col-sm-9">
