<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="SalesByItemSummaryMNRprt.aspx.cs" Inherits="DSCMS.Views.Report.SalesByItemSummaryMNRprt" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
   NCEDCOS | Sales By Item Summary Member or Non Member
</asp:Content>
    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li class="active">
                        <i class="fa fa-flag "></i> NCE DCO Sales By Item Summary Member or Non Member
                    </li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="col col-sm-12 form-inline">
                            ...
                            <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="drpNCEMember" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem Value="No">Non Member</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
