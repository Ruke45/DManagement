...
namespace DSCMS.Views.Report
{
    public partial class SalesbyCustomer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!authorized.IsUserGroupAuthorised(userSession.User_Group, "SALEBCUS_R"))
            {
        ...
        private void GenarateReport()
        {
            ...
            ReportDataSource Rds = new ReportDataSource("SalesByCustomer", Ds);

            ReportViewer1.LocalReport.DataSources.Add(Rds);
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/SalesByCustomer.rdlc");
