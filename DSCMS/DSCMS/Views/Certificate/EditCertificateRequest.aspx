<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="EditCertificateRequest.aspx.cs" Inherits="DSCMS.EditCertificateRequest" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    NCEDCOS | Edit Certificater Request
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-lg-11">
                ...
                <div class="form-horizontal" role="form" style="font-family: Cambria;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtExporter" CssClass="form-control" onkeypress="if (this.value.length > 500) { this.value = this.value.substring(0, 500); }" TextMode="MultiLine" Height="110" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <asp:TextBox ID="txtPortLoading" CssClass="form-control" runat="server" MaxLength="32"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="divOtherComments" runat="server">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtOtherComments" CssClass="form-control" runat="server" MaxLength="110"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="diveRemarkGlobl" runat="server">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:TextBox ID="txtOtherDetails" TextMode="MultiLine" CssClass="form-control" runat="server" MaxLength="245"></asp:TextBox>
                        </div>
                    </div>
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col col-xs-2 text-right">
                                            ...
                                            <asp:Button ID="btnAddNewItem" CssClass="btn btn-sm btn-default btn-create" runat="server" Text="Add Good / Item" Visible="false" OnClick="btnAddNewItem_Click" />
                                        </div>
                                            ...
                                            <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup modal-dialog modal-lg" Style="display: none">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <asp:Button ID="btnAddItem" runat="server" Text="Update" CssClass="btn btn-primary" OnClick="btnAddItem_Click" />
                    ...
                    <div class="container-fulid" id="ROWBase" runat="server">
                        <div class="form-group" id="div1" runat="server">
                            ...
                            <div class="col-sm-8">
                                ...
                                <asp:TextBox ID="txtGoodDetails" TextMode="MultiLine" onkeypress="if (this.value.length > 500) { this.value = this.value.substring(0, 500); }" Height="200" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="HSDetails" runat="server">
                            ...
                            <div class="col-sm-8">
                                ...
                                <asp:TextBox ID="txtHSDetails" TextMode="MultiLine" CssClass="form-control" onkeypress="if (this.value.length > 200) { this.value = this.value.substring(0, 200); }" runat="server"></asp:TextBox>
                            </div>
                        </div>
                                    ...
                                    <asp:GridView ID="gvSupportingDOc" runat="server" CssClass="table table-responsive  table-bordered  table-hover t" AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Signature Required">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkSelect" runat="server" Checked='<%# Eval("Signature_Required") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField>
                                                <HeaderStyle CssClass="hdrow" />
                                                <HeaderTemplate>
                                                    <asp:Label ID="Label2" runat="server" Text="Upload New Document"></asp:Label>
                                                </HeaderTemplate>
                                                <ItemTemplate>
    ...
    runat="server" Display="Dynamic" ForeColor="Red" />--%>
                    ...
                    <div class="form-group text-right">
                        <div class="col-sm-12">
                            <asp:Button ID="btnUpdateCertificate" runat="server" Text="Update Certificate" CssClass="btn btn-primary" Width="200px" OnClick="btnUpdateCertificate_Click" />
                            <asp:Button ID="btnSendForApproval" runat="server" Text="Send For Approval" CssClass="btn btn-primary" Width="200px" OnClick="btnSendForApproval_Click" />
                        </div>
                    </div>
                </div>
            </div>
