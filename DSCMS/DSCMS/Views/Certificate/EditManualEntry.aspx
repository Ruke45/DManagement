<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="EditManualEntry.aspx.cs" MasterPageFile="~/Master.Master" Inherits="DSCMS.Views.Certificate.EditManualEntry" %>
        ...
        <div class="col-lg-12">
                  <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-th-large"></i> Certificate Status
                            </li>
                        </ol>
                    </div>
                </div>
                      ...
                      <form action="#" method="get">
                        <div class="input-group">
                            ...
                            <asp:Button ID="btnShow" runat="server" Width="200" CssClass="btn btn-Secondary" Text="Edit" style="display:none" visible="false"/>
                                <asp:Button ID="btnTdelete" runat="server"  CssClass="btn btn-Secondary" Text="Edit" style="display:none" visible="false"/>
            <asp:Button ID="btnShow2" CssClass="btn btn-primary"  runat="server" style="display:none" Text="Add New" />
...
<asp:Panel ID="Panel1" runat="server" Width="1200px"   CssClass="modalPopup modal-dialog modal-lg" align="center" style = "display:none">
    <!-- Modal content--><div id="Div1" runat="server" style="max-height: 500px; overflow: auto;">
          ...
          <iframe name="myIframe" id="myIframe" width="950px" height="400px" runat ="server" ></iframe>
            ...
            <div class="col-lg-11">
                ...
                <div class="form-horizontal" role="form" style="font-family: Cambria;">
                    ...
                    <%-- <div class="form-group">
                        <label class="control-label col-sm-2" for="email">Good Item R</label>
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtGoodItem"  BackColor="White" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                        <label class="control-label col-sm-2" for="email">Shipping MarkR</label>
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtShippingMark"  BackColor="White" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="control-label col-sm-2" for="email">Package TypeR</label>
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtPackageType"  BackColor="White" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                        <label class="control-label col-sm-2" for="email">SummaryDesc R</label>
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtSummaryDesc"  BackColor="White" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="email">Quantity R</label>
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtQuantity"  BackColor="White" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                        <label class="control-label col-sm-2" for="email">HSCode R</label>
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtHSCode"  BackColor="White" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>--%>
                                            ...
                                            <asp:GridView ID="GridView2" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="HS Code" DataField="HSCode1" SortExpression="HSCode1" />
                                                     <asp:TemplateField Visible="false">
                                      <ItemTemplate>
                                          <asp:Label ID ="lblRunningNo" runat="server" Text='<%#Eval("CreatedBy1") %>'></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="" Visible="false">
                                                     <ItemTemplate>
                                                            <asp:LinkButton ID="linkEditItems" runat="server" OnClick="linkEditItem_Click">Edit</asp:LinkButton>
                                                        </ItemTemplate>
                                                        </asp:TemplateField>
...
<!-- Modal -->
    ...
    CancelControlID="Button3" BackgroundCssClass="modalBackground"></cc1:ModalPopupExtender>
